...
var getRect = (element) => {
  if (isWindow(element)) {
    ...
    return __spreadProps$a(__spreadValues$u({}, rect), {
      toJSON: () => rect
    });
  }
...
function useChildren(key) {
  ...
  const bindChildren = (parentProvider) => {
    vue.provide(key, __spreadValues$t({
      childInstances,
      collect,
      clear: clear2
    }, parentProvider));
  ...
  target.setPropsDefaults = function(defaults) {
    Object.entries(defaults).forEach(([key, value]) => {
      ...
      if (isPlainObject(prop)) {
        props2[key] = __spreadProps$9(__spreadValues$s({}, prop), {
          default: value
        });
        return;
      }
...
function mountInstance(component, props2 = {}, eventListener = {}) {
  const Host = {
    setup() {
      return () => vue.h(component, __spreadValues$s(__spreadValues$s({}, props2), eventListener));
    }
  };
...
function useValidation() {
  ...
  const validate = (rules, value, apis) => __async$h(this, null, function* () {
  ...
  const validateWithTrigger = (validateTrigger, trigger, rules, value, apis) => __async$h(this, null, function* () {
...
function removeRipple() {
  ...
  const task = () => {
    ...
    const delay = ANIMATION_DURATION$1 - performance.now() + Number(lastRipple.dataset.createdAt);
    window.setTimeout(() => {
...
function mounted$2(el, binding) {
  var _a;
  el._ripple = __spreadProps$8(__spreadValues$r({
    tasker: null
...
const props$1d = __spreadValues$p({
  show: Boolean,
  title: String,
  actions: {
    type: Array,
...
function useLocale() {
  ...
  const merge2 = (lang, pack3) => {
    if (!packs2[lang]) {
      console.warn(`The ${lang} does not exist. You can mount a language package using the add method`);
      return;
    }
    packs2[lang] = __spreadValues$o(__spreadValues$o({}, packs2[lang]), pack3);
    use2(lang);
  };
  return {
    packs: packs2,
          ...
          vue.renderSlot(_ctx.$slots, "title", {}, () => {
            ...
            return [
              vue.createElementVNode(
                ...
                vue.toDisplayString((_a = _ctx.title) != null ? _a : _ctx.pack.actionSheetTitle),
                3
                /* TEXT, CLASS */
              )
            ];
...
function normalizeOptions$3(options = {}) {
  return __spreadValues$n(__spreadValues$n({}, defaultOptions$3), options);
}
...
const props$17 = {
  ...
  loadingColor: __spreadProps$7(__spreadValues$l({}, pickProps(props$19, "color")), {
...
const __sfc__$1c = vue.defineComponent({
  ...
  setup(props2, { slots }) {
    ...
    vue.watch(
      () => props2.fabProps,
      (newValue) => {
        fabProps.value = __spreadValues$k(__spreadValues$k({}, defaultFabProps), newValue);
      },
        ...
        [
          vue.renderSlot(_ctx.$slots, "image", {}, () => [
            _ctx.src ? (vue.openBlock(), vue.createElementBlock("img", {
              ...
              src: _ctx.src,
              alt: _ctx.alt
            }, null, 14, _hoisted_1$p)) : vue.createCommentVNode("v-if", true)
          ]),
          vue.createElementVNode(
            "div",
            {
...
function useForm() {
  ...
  const bindForm = bindParent ? (formItemProvider) => {
    bindParent(__spreadProps$6(__spreadValues$j({}, formItemProvider), { instance }));
  } : null;
  return {
    index,
    form: parentProvider,
...
const { name: name$S, n: n$Z } = createNamespace("countdown");
const SECOND = 1e3;
...
var stdin_default$2B = __sfc__$_;
withInstall(stdin_default$2B);
withPropsDefaultsSetter(stdin_default$2B, props$S);
const _CountdownComponent = stdin_default$2B;
...
var stdin_default$2z = __sfc__$Z;
withInstall(stdin_default$2z);
withPropsDefaultsSetter(stdin_default$2z, props$R);
const _CounterComponent = stdin_default$2z;
var stdin_default$2y = stdin_default$2z;
...
const { n: n$X } = createNamespace("picker-header");
...
var stdin_default$2x = __sfc__$Y;
...
const { n: n$W, classes: classes$O } = createNamespace("month-picker");
  ...
  setup(props2, { emit }) {
    ...
    const buttonProps = (key) => {
      ...
      return {
        ...
        class: classes$O(n$W("button"), [disabled, n$W("button--disabled")]),
        disabled
      };
    };
...
withInstall(stdin_default$2v);
withPropsDefaultsSetter(stdin_default$2v, props$P);
...
withInstall(stdin_default$2r);
withPropsDefaultsSetter(stdin_default$2r, props$Q);
          ...
          vue.createElementVNode(
            ...
            [
              vue.renderSlot(_ctx.$slots, "title", {}, () => {
                ...
                return [
                  vue.createTextVNode(
                    vue.toDisplayString((_a = _ctx.title) != null ? _a : _ctx.pack.dialogTitle),
                    1
                    /* TEXT */
                  )
                ];
            ...
            [
              _ctx.cancelButton ? (vue.openBlock(), vue.createBlock(_component_var_button, {
                ...
                default: vue.withCtx(() => {
                  ...
                  return [
                    vue.createTextVNode(
                      vue.toDisplayString((_a = _ctx.cancelButtonText) != null ? _a : _ctx.pack.dialogCancelButtonText),
                      1
                      /* TEXT */
                    )
                  ];
              ...
              _ctx.confirmButton ? (vue.openBlock(), vue.createBlock(_component_var_button, {
                ...
                default: vue.withCtx(() => {
                  ...
                  return [
                    vue.createTextVNode(
                      vue.toDisplayString((_a = _ctx.confirmButtonText) != null ? _a : _ctx.pack.dialogConfirmButtonText),
                      1
                      /* TEXT */
                    )
                  ];
...
withInstall(stdin_default$2n);
withPropsDefaultsSetter(stdin_default$2n, props$N);
...
withInstall(stdin_default$2l);
withPropsDefaultsSetter(stdin_default$2l, props$M);
...
function usePopover(options) {
  ...
  const hostSize = vue.ref({ width: 0, height: 0 });
  ...
  const getPopperOptions = () => {
    ...
    const modifiers = [
      __spreadProps$3(__spreadValues$b({}, flip$1), {
        enabled: show.value
      }),
      __spreadProps$3(__spreadValues$b({}, offset$1), {
        options: {
          offset: [skidding, distance]
        }
      }),
      __spreadProps$3(__spreadValues$b({}, computeStyles$1), {
        options: {
          adaptive: false,
...
withInstall(stdin_default$2j);
withPropsDefaultsSetter(stdin_default$2j, props$L);
...
const __sfc__$O = vue.defineComponent({
  ...
  setup(props2) {
    ...
    const tooltipProps = vue.computed(() => {
      ...
      return __spreadValues$a({ sameWidth: true }, props2.tooltip);
    });
    function handleClick() {
...
withInstall(stdin_default$2h);
withPropsDefaultsSetter(stdin_default$2h, props$K);
...
withInstall(stdin_default$2f);
withPropsDefaultsSetter(stdin_default$2f, props$J);
        ...
        [
          _ctx.variant === "outlined" ? (vue.openBlock(), vue.createElementBlock(
            ...
            "div",
            {
              ...
              style: vue.normalizeStyle({ background: !_ctx.errorMessage ? _ctx.blurColor : void 0 })
            },
            [
              vue.createElementVNode(
                "div",
                {
                  ...
                  style: vue.normalizeStyle({ background: !_ctx.errorMessage ? _ctx.focusColor : void 0 })
                },
                null,
                6
                /* CLASS, STYLE */
...
const __sfc__$N = vue.defineComponent({
  ...
  setup(props2, { slots }) {
    ...
    const isFloating = vue.computed(() => props2.hint && (!isEmpty(props2.value) || props2.isFocus || slots["prepend-icon"]));
...
withInstall(stdin_default$2d);
withPropsDefaultsSetter(stdin_default$2d, props$I);
...
withInstall(stdin_default$2b);
withPropsDefaultsSetter(stdin_default$2b, props$H);
...
withPropsDefaultsSetter(stdin_default$29, props$G);
...
withPropsDefaultsSetter(stdin_default$27, props$F);
...
withPropsDefaultsSetter(stdin_default$25, props$E);
...
const __sfc__$H = vue.defineComponent({
  ...
  setup(props2) {
    ...
    const initialIndex = vue.computed(() => {
...
function normalizeOptions$1(options = {}) {
  if (isString(options)) {
    return __spreadProps$2(__spreadValues$8({}, defaultOptions$1), { images: [options] });
  }
  if (isArray(options)) {
    return __spreadProps$2(__spreadValues$8({}, defaultOptions$1), { images: options });
  }
  return __spreadValues$8(__spreadValues$8({}, defaultOptions$1), options);
}
...
const { name: name$B, n: n$E, classes: classes$y } = createNamespace("index-anchor");
...
var stdin_default$1$ = __sfc__$G;
withInstall(stdin_default$1$);
withPropsDefaultsSetter(stdin_default$1$, props$C);
const _IndexAnchorComponent = stdin_default$1$;
var stdin_default$1_ = stdin_default$1$;
const props$B = {
  sticky: {
    type: Boolean,
    default: true
  ...
  setup(props2) {
    ...
    function anchorClick(_0) {
      return __async$6(this, arguments, function* ({ anchorName, manualCall = false, options }) {
        ...
        const offsetTop = getOffsetTop();
        const top2 = indexAnchor.ownTop.value - stickyOffsetTop.value + offsetTop;
        const left2 = getScrollLeft(scroller);
...
var stdin_default$1Z = __sfc__$F;
withInstall(stdin_default$1Z);
withPropsDefaultsSetter(stdin_default$1Z, props$B);
const _IndexBarComponent = stdin_default$1Z;
var stdin_default$1Y = stdin_default$1Z;
...
const props$A = __spreadValues$7({
  modelValue: String,
  modelModifiers: {
    type: Object,
    default: () => ({})
...
const _hoisted_1$g = ["placeholder", "enterkeyhint"];
      ...
      vue.createVNode(
        ...
        vue.createSlots({
          ...
          default: vue.withCtx(() => [
            ...
            }, null, 14, _hoisted_1$g)) : vue.createCommentVNode("v-if", true),
...
var stdin_default$1X = __sfc__$E;
withInstall(stdin_default$1X);
withPropsDefaultsSetter(stdin_default$1X, props$A);
const _InputComponent = stdin_default$1X;
var stdin_default$1W = stdin_default$1X;
const props$z = {
  type: {
    type: String,
    default: "default"
...
const { name: name$y, n: n$B, classes: classes$v } = createNamespace("link");
...
var stdin_default$1V = __sfc__$D;
withInstall(stdin_default$1V);
withPropsDefaultsSetter(stdin_default$1V, props$z);
const _LinkComponent = stdin_default$1V;
var stdin_default$1U = stdin_default$1V;
const props$y = {
  loading: Boolean,
  immediateCheck: {
    type: Boolean,
          ...
          vue.createElementVNode(
            ...
            [
              vue.createElementVNode(
                ...
                vue.toDisplayString((_a = _ctx.loadingText) != null ? _a : _ctx.pack.listLoadingText),
                3
                /* TEXT, CLASS */
              ),
      ...
      _ctx.finished ? vue.renderSlot(_ctx.$slots, "finished", { key: 1 }, () => {
        ...
        return [
          vue.createElementVNode(
            ...
            vue.toDisplayString((_a = _ctx.finishedText) != null ? _a : _ctx.pack.listFinishedText),
            3
            /* TEXT, CLASS */
          )
        ];
      ...
      _ctx.error ? vue.renderSlot(_ctx.$slots, "error", { key: 2 }, () => {
        ...
        return [
          vue.withDirectives((vue.openBlock(), vue.createElementBlock(
            ...
            [
              vue.createTextVNode(
                vue.toDisplayString((_a = _ctx.errorText) != null ? _a : _ctx.pack.listErrorText),
                1
                /* TEXT */
              )
            ],
...
var stdin_default$1T = __sfc__$C;
withInstall(stdin_default$1T);
withPropsDefaultsSetter(stdin_default$1T, props$y);
const _ListComponent = stdin_default$1T;
...
const props$w = vue.reactive(internalProps);
const mergeConfig = (options) => {
  Object.assign(props$w, options);
};
...
const mount = () => {
  if (!isMount$1) {
    isMount$1 = true;
    mountInstance(stdin_default$1R, props$w);
  }
};
const tickValue = () => {
...
var stdin_default$1Q = LoadingBar;
const props$v = {
  show: Boolean,
  disabled: Boolean,
  trigger: {
...
var stdin_default$1P = __sfc__$B;
withInstall(stdin_default$1P);
withPropsDefaultsSetter(stdin_default$1P, props$v);
const _MenuComponent = stdin_default$1P;
var stdin_default$1O = stdin_default$1P;
...
var stdin_default$1N = __sfc__$A;
withInstall(stdin_default$1N);
withPropsDefaultsSetter(stdin_default$1N, props$u);
const _MenuOptionComponent = stdin_default$1N;
var stdin_default$1M = stdin_default$1N;
...
const props$t = __spreadValues$6({
  modelValue: {
    default: void 0
  },
  size: {
...
__sfc__$z.render = __render__$y;
var stdin_default$1L = __sfc__$z;
withInstall(stdin_default$1L);
withPropsDefaultsSetter(stdin_default$1L, props$t);
const _MenuSelectComponent = stdin_default$1L;
var stdin_default$1K = stdin_default$1L;
...
__sfc__$y.render = __render__$x;
var stdin_default$1J = __sfc__$y;
withInstall(stdin_default$1J);
withPropsDefaultsSetter(stdin_default$1J, props$s);
const _OptionComponent = stdin_default$1J;
var stdin_default$1I = stdin_default$1J;
const props$r = {
  show: Boolean,
  lockScroll: {
    type: Boolean,
...
withInstall(stdin_default$1H);
withPropsDefaultsSetter(stdin_default$1H, props$r);
const _OverlayComponent = stdin_default$1H;
var stdin_default$1G = stdin_default$1H;
const props$q = {
            ...
            default: vue.withCtx(() => [
              vue.createElementVNode(
                "div",
                {
                  ...
                  onClick: _cache[5] || (_cache[5] = vue.withModifiers((...args) => _ctx.showMenu && _ctx.showMenu(...args), ["stop"]))
                },
                [
                  vue.createElementVNode(
                    "span",
...
__sfc__$x.render = __render__$w;
var stdin_default$1F = __sfc__$x;
withInstall(stdin_default$1F);
withPropsDefaultsSetter(stdin_default$1F, props$q);
const _PaginationComponent = stdin_default$1F;
var stdin_default$1E = stdin_default$1F;
const props$p = {
  elevation: {
    type: [Boolean, Number, String],
    default: false
...
__sfc__$w.render = __render__$v;
var stdin_default$1D = __sfc__$w;
withInstall(stdin_default$1D);
withPropsDefaultsSetter(stdin_default$1D, props$p);
const _PaperComponent = stdin_default$1D;
var stdin_default$1C = stdin_default$1D;
...
const props$o = __spreadValues$5({
  modelValue: {
    type: Array,
    default: () => []
  },
                ...
                vue.renderSlot(_ctx.$slots, "cancel", {}, () => [
                  vue.createVNode(_component_var_button, {
                    ...
                    default: vue.withCtx(() => {
                      ...
                      return [
                        vue.createTextVNode(
                          vue.toDisplayString((_a = _ctx.cancelButtonText) != null ? _a : _ctx.pack.pickerCancelButtonText),
                          1
                          /* TEXT */
                        )
                      ];
                ...
                vue.renderSlot(_ctx.$slots, "title", {}, () => {
                  ...
                  return [
                    vue.createElementVNode(
                      ...
                      vue.toDisplayString((_a = _ctx.title) != null ? _a : _ctx.pack.pickerTitle),
                      3
                      /* TEXT, CLASS */
                    )
                  ];
                ...
                vue.renderSlot(_ctx.$slots, "confirm", {}, () => [
                  vue.createVNode(_component_var_button, {
                    ...
                    default: vue.withCtx(() => {
                      ...
                      return [
                        vue.createTextVNode(
                          vue.toDisplayString((_a = _ctx.confirmButtonText) != null ? _a : _ctx.pack.pickerConfirmButtonText),
                          1
                          /* TEXT */
                        )
                      ];
...
__sfc__$v.render = __render__$u;
var stdin_default$1B = __sfc__$v;
...
function Picker(options) {
  return new Promise((resolve) => {
    ...
    const { unmountInstance } = mountInstance(stdin_default$1B, reactivePickerOptions, {
...
Picker.Component = stdin_default$1B;
withInstall(stdin_default$1B);
withInstall(stdin_default$1B, Picker);
withPropsDefaultsSetter(Picker, props$o);
const _PickerComponent = stdin_default$1B;
...
__sfc__$u.render = __render__$t;
var stdin_default$1z = __sfc__$u;
withInstall(stdin_default$1z);
withPropsDefaultsSetter(stdin_default$1z, props$n);
const _ProgressComponent = stdin_default$1z;
var stdin_default$1y = stdin_default$1z;
const props$m = {
  modelValue: Boolean,
  disabled: Boolean,
...
__sfc__$t.render = __render__$s;
var stdin_default$1x = __sfc__$t;
withInstall(stdin_default$1x);
withPropsDefaultsSetter(stdin_default$1x, props$m);
const _PullRefreshComponent = stdin_default$1x;
var stdin_default$1w = stdin_default$1x;
const props$l = {
  modelValue: {
    type: [String, Number, Boolean, Object, Array],
...
__sfc__$s.render = __render__$r;
var stdin_default$1v = __sfc__$s;
withInstall(stdin_default$1v);
withPropsDefaultsSetter(stdin_default$1v, props$l);
const _RadioComponent = stdin_default$1v;
var stdin_default$1u = stdin_default$1v;
const props$k = {
  modelValue: {
    type: [String, Number, Boolean, Object, Array],
...
__sfc__$r.render = __render__$q;
var stdin_default$1t = __sfc__$r;
withInstall(stdin_default$1t);
withPropsDefaultsSetter(stdin_default$1t, props$k);
const _RadioGroupComponent = stdin_default$1t;
var stdin_default$1s = stdin_default$1t;
const props$j = {
  modelValue: {
    type: Number,
...
__sfc__$q.render = __render__$p;
var stdin_default$1r = __sfc__$q;
withInstall(stdin_default$1r);
withPropsDefaultsSetter(stdin_default$1r, props$j);
...
const _hoisted_2$8 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ vue.createElementVNode(
  "path",
...
const __sfc__$n = vue.defineComponent({});
__sfc__$n.render = __render__$m;
var stdin_default$1n = __sfc__$n;
...
const _hoisted_1$7 = { viewBox: "-4 -4 32 32" };
...
const __sfc__$k = vue.defineComponent({});
__sfc__$k.render = __render__$j;
var stdin_default$1k = __sfc__$k;
const props$i = {
...
const __sfc__$j = vue.defineComponent({
  name: name$i,
  components: {
    Info: stdin_default$1p,
    Success: stdin_default$1m,
    Warning: stdin_default$1n,
    Error: stdin_default$1o,
    Question: stdin_default$1l,
    Empty: stdin_default$1k
  },
  props: props$i,
  setup(props2) {
...
__sfc__$j.render = __render__$i;
var stdin_default$1j = __sfc__$j;
withInstall(stdin_default$1j);
withPropsDefaultsSetter(stdin_default$1j, props$i);
const _ResultComponent = stdin_default$1j;
var stdin_default$1i = stdin_default$1j;
const props$h = {
  gutter: {
...
__sfc__$i.render = __render__$h;
var stdin_default$1h = __sfc__$i;
withInstall(stdin_default$1h);
withPropsDefaultsSetter(stdin_default$1h, props$h);
const _RowComponent = stdin_default$1h;
var stdin_default$1g = stdin_default$1h;
...
const props$g = __spreadValues$4({
  modelValue: {
    default: void 0
  },
  multiple: Boolean,
...
__sfc__$h.render = __render__$g;
var stdin_default$1f = __sfc__$h;
withInstall(stdin_default$1f);
withPropsDefaultsSetter(stdin_default$1f, props$g);
const _SelectComponent = stdin_default$1f;
var stdin_default$1e = stdin_default$1f;
const props$f = {
  loading: {
    type: Boolean,
...
__sfc__$g.render = __render__$f;
var stdin_default$1d = __sfc__$g;
withInstall(stdin_default$1d);
withPropsDefaultsSetter(stdin_default$1d, props$f);
const _SkeletonComponent = stdin_default$1d;
var stdin_default$1c = stdin_default$1d;
...
const _hoisted_1$5 = ["onTouchstart"];
function __render__$e(_ctx, _cache) {
  const _component_var_hover_overlay = vue.resolveComponent("var-hover-overlay");
  const _component_var_form_details = vue.resolveComponent("var-form-details");
  const _directive_hover = vue.resolveDirective("hover");
...
__sfc__$f.render = __render__$e;
var stdin_default$1b = __sfc__$f;
withInstall(stdin_default$1b);
withPropsDefaultsSetter(stdin_default$1b, props$e);
const _SliderComponent = stdin_default$1b;
var stdin_default$1a = stdin_default$1b;
...
const __sfc__$e = vue.defineComponent({
  ...
  setup(props2) {
    ...
    const isForbidClick = vue.computed(() => props2.type === "loading" || props2.forbidClick);
...
__sfc__$e.render = __render__$d;
var stdin_default$19 = __sfc__$e;
...
const __sfc__$d = vue.defineComponent({
  name: name$d,
  components: { VarSnackbarCore: stdin_default$19 },
  props: props$d,
  setup() {
...
__sfc__$d.render = __render__$c;
var stdin_default$18 = __sfc__$d;
...
const Snackbar = function(options) {
  ...
  const reactiveSnackOptions = vue.reactive(__spreadValues$2(__spreadValues$2({}, defaultOptions), snackOptions));
...
function updateUniqOption(reactiveSnackOptions, _update) {
  ...
  firstOption.reactiveSnackOptions = __spreadValues$2(__spreadValues$2({}, firstOption.reactiveSnackOptions), reactiveSnackOptions);
...
Snackbar.Component = stdin_default$18;
withInstall(stdin_default$18);
withInstall(stdin_default$18, Snackbar);
withPropsDefaultsSetter(Snackbar, props$d);
const _SnackbarComponent = stdin_default$18;
var stdin_default$17 = Snackbar;
const props$c = {
  size: {
    type: [String, Number, Array],
    default: "normal"
...
withInstall(stdin_default$16);
withPropsDefaultsSetter(stdin_default$16, props$c);
const _SpaceComponent = stdin_default$16;
var stdin_default$15 = stdin_default$16;
const props$b = {
  activeIcon: {
    type: String,
    default: "check"
...
__sfc__$c.render = __render__$b;
var stdin_default$14 = __sfc__$c;
withInstall(stdin_default$14);
withPropsDefaultsSetter(stdin_default$14, props$b);
const _StepComponent = stdin_default$14;
var stdin_default$13 = stdin_default$14;
const props$a = {
  active: {
    type: [String, Number],
    default: 0
...
__sfc__$b.render = __render__$a;
var stdin_default$12 = __sfc__$b;
withInstall(stdin_default$12);
withPropsDefaultsSetter(stdin_default$12, props$a);
const _StepsComponent = stdin_default$12;
var stdin_default$11 = stdin_default$12;
const props$9 = {
  styleVars: {
    type: Object,
    default: () => ({})
...
var stdin_default$10 = __sfc__$a;
...
StyleProvider.Component = stdin_default$10;
withInstall(stdin_default$10);
withInstall(stdin_default$10, StyleProvider);
withPropsDefaultsSetter(StyleProvider, props$9);
const _StyleProviderComponent = stdin_default$10;
...
const _hoisted_1$3 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ vue.createElementVNode(
  "svg",
  { viewBox: "25 25 50 50" },
  [
    /* @__PURE__ */ vue.createElementVNode("circle", {
...
var stdin_default$_ = __sfc__$9;
withInstall(stdin_default$_);
withPropsDefaultsSetter(stdin_default$_, props$8);
const _SwitchComponent = stdin_default$_;
var stdin_default$Z = stdin_default$_;
const props$7 = {
  name: [String, Number],
  disabled: Boolean,
  ripple: {
...
var stdin_default$Y = __sfc__$8;
withInstall(stdin_default$Y);
withPropsDefaultsSetter(stdin_default$Y, props$7);
const _TabComponent = stdin_default$Y;
var stdin_default$X = stdin_default$Y;
const props$6 = {
  name: [String, Number]
};
...
var stdin_default$W = __sfc__$7;
withInstall(stdin_default$W);
withPropsDefaultsSetter(stdin_default$W, props$6);
const _TabItemComponent = stdin_default$W;
var stdin_default$V = stdin_default$W;
const props$5 = {
  fullWidth: {
    type: [Number, String],
    default: "100%"
...
var stdin_default$U = __sfc__$6;
withInstall(stdin_default$U);
withPropsDefaultsSetter(stdin_default$U, props$5);
const _TableComponent = stdin_default$U;
var stdin_default$T = stdin_default$U;
const props$4 = {
  active: {
    type: [String, Number],
    default: 0
...
var stdin_default$S = __sfc__$5;
withInstall(stdin_default$S);
withPropsDefaultsSetter(stdin_default$S, props$4);
const _TabsComponent = stdin_default$S;
var stdin_default$R = stdin_default$S;
const props$3 = {
  active: {
    type: [String, Number],
    default: 0
...
var stdin_default$Q = __sfc__$4;
withInstall(stdin_default$Q);
withPropsDefaultsSetter(stdin_default$Q, props$3);
const _TabsItemsComponent = stdin_default$Q;
...
var stdin_default$8 = __spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1(__spreadValues$1({
  // common
  "--color-body": "#1e1e1e",
  "--color-text": "#fff",
...
}, stdin_default$M), stdin_default$K), stdin_default$L), stdin_default$p), stdin_default$G), stdin_default$u), stdin_default$n), stdin_default$r), stdin_default$z), stdin_default$F), stdin_default$O), stdin_default$I), stdin_default$N), stdin_default$o), stdin_default$H), stdin_default$y), stdin_default$s), stdin_default$t), stdin_default$B), stdin_default$q), stdin_default$C), stdin_default$v), stdin_default$x), stdin_default$J), stdin_default$E), stdin_default$A), stdin_default$m), stdin_default$l), stdin_default$k), stdin_default$j), stdin_default$w), stdin_default$i), stdin_default$h), stdin_default$g), stdin_default$f), stdin_default$e), stdin_default$d), stdin_default$c), stdin_default$b), stdin_default$a), stdin_default$9), stdin_default$D);
const Themes = { dark: stdin_default$8 };
...
function install(app) {
  ...
  stdin_default$1c.install && app.use(stdin_default$1c);
  stdin_default$1a.install && app.use(stdin_default$1a);
  stdin_default$17.install && app.use(stdin_default$17);
  ...
  stdin_default$T.install && app.use(stdin_default$T);
  stdin_default$R.install && app.use(stdin_default$R);
...
const index_bundle = {
  ...
  Option: stdin_default$1I,
  Overlay: stdin_default$1G,
  ...
  Slider: stdin_default$1a,
  Snackbar: stdin_default$17,
  ...
  Table: stdin_default$T,
  Tabs: stdin_default$R,
...
exports.Option = stdin_default$1I;
exports.Overlay = stdin_default$1G;
exports.PIXEL = PIXEL;
...
exports.Skeleton = stdin_default$1c;
exports.Slider = stdin_default$1a;
exports.Snackbar = stdin_default$17;
...
exports.Table = stdin_default$T;
exports.Tabs = stdin_default$R;
